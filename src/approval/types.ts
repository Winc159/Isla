...
export interface ApprovalRequestOptions { readonly signal?: AbortSignal; }
export interface ApprovalService { request(request: ApprovalRequest, options?: ApprovalRequestOptions): Promise<ApprovalDecision>; }

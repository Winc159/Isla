...
export interface CommandExecutionToolDetails { readonly type: "command_execution"; readonly shell: "powershell" | "bash" | "direct"; readonly workdir: string; readonly exitCode: number | null; readonly signal: NodeJS.Signals | null; readonly timedOut: boolean; readonly aborted: boolean; readonly purpose: "verification" | "other"; readonly stdoutTruncated: boolean; readonly stderrTruncated: boolean; }
